...
# - Passwords with special characters may cause tcl or bash errors; a backslash must be entered by the user in front of some special character for proper escaping. (github Issue #3 and #16)
...
sys application template /Common/f5.automated_backup.v3.1.5 {
    actions {
        definition {
            html-help {
            }
