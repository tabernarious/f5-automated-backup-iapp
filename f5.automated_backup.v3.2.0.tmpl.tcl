# The included features/changes have been merged into release v3.2.1 on https://github.com/tabernarious/f5-automated-backup-iapp
# This was developed on top of v3.1.9 on https://github.com/YaleUniversity/f5-automated-backup-iapp/tree/feature/add_support_sftp

cli admin-partitions {
    update-partition Common
}
sys application template /Common/f5.automated_backup.v3.2.0 {
    actions {
        definition {
            html-help {
            }
				...
				optional ( backup_schedule.frequency_select != "Disable" ) {
					section destination_parameters {
						...
						optional ( protocol_enable == "Remotely via SCP") {
							message scp_help "A connection to an SSH server using SCP.  SCP: a remote file copy program."
						...
						optional ( protocol_enable == "Remotely via SFTP") {
							message sftp_help "A connection to an SSH server using SFTP.  SFTP is an interactive file transfer program, similar to ftp."
							...
							string sftp_remote_directory display "large"
                            message sftp_remote_directory_help "Full path without a trailing slash (e.g. '/home/user1/f5_backups/prod')."
						}
