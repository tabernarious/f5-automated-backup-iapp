...
# v3.1.10 - 20201209 - Added SMB Version and SMB Security options to support v14+ and newer versions of Microsoft Windows and Windows Server.
...
sys application template /Common/f5.automated_backup.v3.1.10 {
    actions {
        definition {
            html-help {
            }
                ...
                if { $freq != "Disable" } {
                    ...
                    elseif { $::destination_parameters__protocol_enable eq "Remotely via SMB/CIFS" } {
                        ...
                        set script {
                            ...
                            if { [catch {exec $scriptfile} catcherror ] } {
                                exec echo "Catch Error: $catcherror" >> /var/tmp/scriptd.out
