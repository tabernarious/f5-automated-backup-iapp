...
# - Passwords with special characters may cause tcl or bash errors; a backslash entered by the user in front of some special characters may fix this. (github Issue #3 and #16)
...
sys application template /Common/f5.automated_backup.v3.1.6 {
    actions {
        definition {
            html-help {
            }
